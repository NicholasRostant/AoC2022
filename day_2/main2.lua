...
for i,v in ipairs(matches) do
    ...
    local my_new_throw = Calc_throw(enemy_throw,my_throw)

    local score = Score_outcome(enemy_throw, my_new_throw)
    Total = Total+score
    print(my_throw,enemy_throw,my_new_throw,score,Total)
end
